...
local RF_Stage1_GetProgress   = ensureRF("RF_Stage5_GetProgress")
local RE_Stage1_QuestSync     = ensureRE("RE_Stage5_QuestSync")
local RE_Stage1_CutsceneFlag  = ensureRE("RE_Stage5_CutsceneFlag")
local RE_Stage1_ObjectCleaned = ensureRE("RE_Stage5_ObjectCleaned")
local RE_Stage1_QuizSolved    = ensureRE("RE_Stage5_QuizSolved") -- ★ 퀴즈 정답 보고
local RE_Stage1_QuizRuntime   = ensureRE("RE_Stage5_QuizRuntime") -- ★ 점수/시간 실시간 저장
