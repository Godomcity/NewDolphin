...
-- ★ 여기만 스테이지마다 다르게 설정!
----------------------------------------------------------------
local STAGE_INDEX = 3 -- Stage1=1, Stage2=2, ... Stage5=5
...
local RE_Stage1_QuizRuntime = Remotes:FindFirstChild("RE_Stage3_QuizRuntime")
if not RE_Stage1_QuizRuntime then
	RE_Stage1_QuizRuntime = Instance.new("RemoteEvent")
	RE_Stage1_QuizRuntime.Name = "RE_Stage3_QuizRuntime"
